...
const img = {
  ...
  connectWhatsapp: { src: "/email/activation/connect-whatsapp.png", alt: "Connect WhatsApp in WhachatCRM" },
  ...
  rge: { src: "/rge-layout-preview.png", alt: "Automation workflow builder" },
};
  ...
  sections: [
    {
      ...
      image: { ...img.connectWhatsapp, caption: "Connect WhatsApp Cloud API from channel settings" },
    },
    {
      id: "embedded-signup",
      ...
      paragraphs: [
        ...
        "Display name and business verification follow Meta's review process. WhachatCRM surfaces status in channel settings and links to troubleshooting when Meta rejects a name or requires additional documentation.",
      ],
      bullets: [
        "No manual long-lived token copy-paste for standard setup",
        "Coexistence options when eligible for Business app + API",
        "Template sync from Meta Business Manager",
        "Test messages before going live with customers",
      ],
      image: { ...img.embeddedSignup, caption: "Guided Meta embedded signup flow" },
    },
    {
      id: "inbox-automation",
    ...
    },
    {
      ...
      image: { ...img.aiCopilot, caption: "AI-assisted messaging on the official API" },
    },
    {
      id: "integrations",
  ...
  sections: [
    {
      ...
      image: { ...img.aiConversation, caption: "Conversation insights powered by AI" },
    },
    {
      id: "buyer-seller",
      ...
      paragraphs: [
        ...
        "Scores update as conversations progress — a lukewarm lead asking for listings twice in one week climbs the queue automatically.",
      ],
      bullets: [
        "Buyer qualification from budget, area, and property signals",
        "Seller qualification from timeline and motivation language",
        "Prioritization queues for managers and round-robin routing",
        "Integration with pipeline stages and Growth Engine triggers",
      ],
    },
    {
      id: "automation",
    ...
    },
    {
      ...
      image: { ...img.inbox, caption: "Lead scores visible beside omnichannel threads" },
    },
  ],
  faqs: [
    {
  ...
  sections: [
    {
      ...
      image: { ...img.inbox, caption: "Shared inbox with assignment and CRM sidebar" },
    },
    {
      id: "notes",
      ...
      paragraphs: [
        ...
        "Pipeline stages and tags complement ownership — a thread may be assigned to Alex while tagged 'VIP' and staged 'Showing scheduled'.",
      ],
      bullets: [
        "Assign to teammate on Pro plans",
        "Internal notes invisible to customers",
        "Lead timeline audit trail",
        "Manager overview without micromanaging every send",
      ],
    },
    {
      id: "ai",
      ...
      image: { ...img.aiCopilot, caption: "AI suggested replies for team efficiency" },
    },
    {
      id: "scale",
  ...
  sections: [
    {
      ...
      image: { ...img.rge, caption: "Visual automation builder with preset templates" },
    },
    {
      id: "ecommerce",
      ...
      paragraphs: [
        ...
        "Connect Shopify so triggers reference live cart and order data. Combine with WhatsApp templates approved in Meta Business Manager for compliant outreach.",
      ],
      bullets: [
        "Abandoned Cart Recovery",
        "Order confirmation and delivery follow-up",
        "Product inquiry nurture",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "No-reply workflows follow up when conversations go quiet — with stage conditions that exclude closed or unqualified leads. See Realtor Growth Engine for done-for-you real estate setup.",
      ],
    },
    {
      id: "support-nurture",
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "WhachatCRM delivers these capabilities without enterprise complexity: embedded signup connects Meta in minutes, and the unified inbox extends to Messenger and Instagram when you need omnichannel coverage.",
      ],
    },
    {
      id: "app-vs-api",
      ...
      bullets: [
        "Business App: free, single device, manual workflows",
        "Cloud API: multi-agent, automation, template messaging",
        "WhachatCRM: embedded signup + inbox + AI + Growth Engine",
      ],
      image: { ...img.embeddedSignup, caption: "Connect the official API with embedded signup" },
    },
    {
      id: "shared-inbox",
      ...
      paragraphs: [
        ...
        "Explore our Unified Inbox and Shared Team Inbox pages for collaboration depth beyond basic message routing.",
      ],
      image: { ...img.inbox, caption: "WhatsApp conversations in a shared CRM inbox" },
    },
    {
      id: "ai-copilot",
      ...
      paragraphs: [
        ...
        "AI assists — humans approve — unless you explicitly configure auto-send automations.",
      ],
      image: { ...img.aiCopilot, caption: "AI Copilot inside WhatsApp CRM" },
    },
    {
      ...
      paragraphs: [
        ...
        "Operational analytics show volume, response patterns, and automation performance — closing the loop between messaging activity and revenue outcomes.",
      ],
      image: { ...img.rge, caption: "Automation templates in WhatsApp CRM" },
    },
    {
      ...
      paragraphs: [
        ...
        "Both verticals share the same WhatsApp CRM foundation — only integrations and templates differ.",
      ],
    },
    {
      id: "support",

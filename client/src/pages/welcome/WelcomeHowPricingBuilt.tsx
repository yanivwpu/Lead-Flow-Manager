      ...
      <section className="px-4 md:px-6 py-16 md:py-20 bg-white">
        <div className="max-w-5xl xl:max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-5">
            {[1, 2, 3].map((step) => (
              <div key={step} className="rounded-[1.5rem] bg-gray-50 p-6 text-left ring-1 ring-gray-100">
                <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-xl bg-brand-green text-lg font-bold text-white">
                  {step}
                </div>

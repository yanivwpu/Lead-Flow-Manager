...
2. Set the Callback URL to: \`https://app.whachatcrm.com/api/webhook/meta\` (or your production \`APP_URL\` + \`/api/webhook/meta\`)
...
\`\`\`html
<script src="https://app.whachatcrm.com/widget.js?id=YOUR_ID"></script>
\`\`\`

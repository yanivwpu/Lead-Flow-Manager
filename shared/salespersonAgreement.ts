...
- Refunded or non-paying accounts
...
11. Acceptance
By accessing or using the WhachatCRM Sales Portal, you acknowledge that:
- You have read and understood this policy
- You agree to the terms described above
- Your acceptance is legally binding
- Your IP address, timestamp, user agent, and salesperson account ID may be stored for compliance and auditing purposes`;

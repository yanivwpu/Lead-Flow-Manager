...
export const PROSPECT_AI_PAGE_CONTAINER_CLASS =
  "mx-auto box-border flex w-full min-w-0 max-w-6xl flex-col gap-2 px-4 py-3 sm:gap-2.5 sm:px-6 sm:py-3.5";
...
export const PROSPECT_AI_TAB_BODY_CLASS = "w-full min-w-0 space-y-2.5";

/** Empty-state outer shell: always full content width. */
export const PROSPECT_AI_EMPTY_STATE_CLASS =
  "w-full rounded-xl border border-dashed border-gray-200 bg-gradient-to-b from-gray-50/60 to-white px-5 py-6 text-center";

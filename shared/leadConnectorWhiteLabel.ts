...
export const CRM_COMPLETE_OAUTH_CTA = "Finish connection";
...
export const CRM_INSTALLED_NOT_CONNECTED =
  "Your CRM app is installed, but authorization is incomplete.";
export const CRM_TOKEN_EXPIRED_DESCRIPTION = "Your CRM connection needs to be renewed.";
export const CRM_CONNECTED_DESCRIPTION = "Your CRM connection is active.";
export const CRM_OPENING_AUTHORIZATION = "Opening your CRM authorization…";

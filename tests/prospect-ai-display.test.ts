...
assert.equal(PROSPECT_LIFECYCLE_QUEUE_LABEL, "Ready to Send");
assert.equal(PROSPECT_SENDING_QUEUE_LABEL, "Ready to Send");
assert.equal(PROSPECT_CAMPAIGN_QUEUE_STATUS_LABELS.queued, "Ready to Send");
assert.equal(prospectCampaignQueueStatusLabel("queued"), "Ready to Send");
